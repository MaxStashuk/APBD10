...
namespace API.Migrations
{
    ...
    [Migration("20250604182451_DevicesDbMigrations")]
    partial class DevicesDbMigrations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.DeviceEmployee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("API.Models.DeviceType", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UQ__DeviceTy__737584F6794BE001")
                        .IsUnique();
            ...
            modelBuilder.Entity("API.Models.Person", b =>
                {
                    ...
                    b.HasIndex(new[] { "PassportNumber" }, "UQ__Person__45809E71CD9A9481")
                        .IsUnique();

                    b.HasIndex(new[] { "PhoneNumber" }, "UQ__Person__85FB4E3866DA8FF7")
                        .IsUnique();

                    b.HasIndex(new[] { "Email" }, "UQ__Person__A9D105349704BC84")
                        .IsUnique();
            ...
            modelBuilder.Entity("API.Models.Position", b =>
                {
                    ...
                    b.HasIndex(new[] { "Name" }, "UQ__Position__737584F6DAED94BB")
                        .IsUnique();
